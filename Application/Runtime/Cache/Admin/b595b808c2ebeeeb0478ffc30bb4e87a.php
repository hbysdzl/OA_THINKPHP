...
<div id="container">
    ...
    <div class="hd-wrap ue-clear">
      ...
      <div class="login-info ue-clear">
        <div class="welcome ue-clear"><span>欢迎您,</span><a href="javascript:;" class="user-name"><?php echo (session('username')); ?></a></div>
         <div class="login-msg ue-clear"> <a href="javascript:;" class="msg-txt">Ip</a> <span><?php echo ($userIp[0]); ?></span><span>地区<?php echo ($userIp[3]); ?>-<?php echo ($userIp[4]); ?></span> </div>
  ...
  <div id="bd">
    <div class="wrap ue-clear">
      <div class="sidebar">
        ...
        <ul class="nav">
          ...
          <li class="nav-info">
            ...
            <ul class="subnav">
              <li><a href="javascript:;" date-src="<?php echo U('User/index');?>">职员列表</a></li>
      ...
      <div class="content">
        <iframe src="<?php echo U('main');?>" id="iframe" name="iframe" width="100%" height="100%" frameborder="0"></iframe>
      </div>
    </div>
  </div>
...
function getEmailnum() {
  $.get("<?php echo U('Email/getEmailCount');?>",function(data){
      $('.msg-num').html(data);
  });
}
  $(function(){
