...
<div class="main">
	<p class="short-input ue-clear">
        ...
        <select name="to_id">
        	...
        	<?php if(is_array($toList)): $i = 0; $__LIST__ = $toList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vol): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vol["id"]); ?>" <?php if($vol["id"] == $from_id ): ?>selected="selected"<?php endif; ?> ><?php echo ($vol["truename"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
        </select>
    </p>
	<p class="short-input ue-clear">
    	<label>标题：</label>
