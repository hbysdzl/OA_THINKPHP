...
<div class="table-operate ue-clear">
    ...
    <a href="<?php echo U('count');?>" class="count">统计</a>
...
<div class="table-box">
	<table>
        ...
        <tbody>
        	<?php if(is_array($showList)): $i = 0; $__LIST__ = $showList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vol): $mod = ($i % 2 );++$i;?><tr>
        		<td class="id"><input type="checkbox" class="check" value="<?php echo ($vol["id"]); ?>" /></td>
            	<td class="id"><?php echo ($i); ?></td>
            	<td class="nickname"><?php echo ($vol["username"]); ?></td>
                ...
                <td class="operate"><a href="javascript:;">查看</a>&nbsp|&nbsp<a href="<?php echo U('edit?id='.$vol['id']);?>">编辑</a></td>
